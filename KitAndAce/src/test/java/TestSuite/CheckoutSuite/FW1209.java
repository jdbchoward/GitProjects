 ...
 * @Description:  User registered, not logged. Checkout without login. Positive
 * @author: Howard
 * @compay: Kit and Ace
 * @date 12/23/2016
 * @version V1.0
...
public class FW1209 {
	...
	static Logger log = Logger.getLogger(FW1209.class.getName());
	...
	@Test
	public void testCheckoutWithoutLoginedOnRegistedUser() throws Exception {
		init();
