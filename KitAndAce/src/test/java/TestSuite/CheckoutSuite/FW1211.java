 ...
 * @Description: Confirmation page display. Logged user.
 * @author: Howard
 * @compay: Kit and Ace
 * @date 12/13/2016
 * @version V1.0
...
public class FW1211 {
	...
	static Logger log = Logger.getLogger(FW1211.class.getName());
...
//		uitestOperation.verifyAnonymousCheckPage(userHybris, billing);	
