 ...
 * @Description: Add new CC for the Order. 'Same as SA' checkbox. Negative
 * @author: Howard
 * @compay: Kit and Ace
 * @date 12/21/2016
 * @version V1.0
...
public class FW1245 {
	...
	static Logger log = Logger.getLogger(FW1245.class.getName());
...
//		uitestOperation.expandCheckout();
		uitestOperation.addCreditCardWhenCheckOutSameAsSA(userHybris,billing);
