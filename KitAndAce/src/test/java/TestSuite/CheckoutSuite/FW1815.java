...
* @Description:  Zip code validation CA anonimous user - positive
* @author: Howard
* @compay: Kit and Ace     
* @date 2/7/2017 
* @version V1.0   
...
public class FW1815 {
	...
	static Logger log = Logger.getLogger(FW1815.class.getName());
	...
	@Test
	public void zipValidationCAanonymousCheckOut() throws Exception {
		...
		//change country
		//vancouver with correct postcode w/o space
		verifyZip(userHybris.getZip(),2,false);
		
		//vancouver with correct postcode with space		
		verifyZip("V5Y 9V9",2,true);

	}
	


   private void verifyZip(String zipCode,int state,boolean saChecked)
   {
