...
* @Description:  Zip code validation AU and NZ anonimous user - positive
* @author: Howard
* @compay: Kit and Ace     
* @date 2/9/2017 
* @version V1.0   
...
public class FW1833 {
	...
	static Logger log = Logger.getLogger(FW1833.class.getName());
	...
	private void init()
	{
		...
		userHybris=uitestOperation.users.get(4);
	...
	@Test
	public void zipValidationUSanonymousCheckOut() throws Exception {
		...
		//change country
		//Sydney NSW
		changeCountryVerifyZip(userHybris.getZip(),2,false);
		//Melbourne victoria
		changeCountryVerifyZip("3006",8,true);
	}
   ...
   private void changeCountryVerifyZip(String zipCode,int state,boolean saChecked)
   {
		//change country
	    if(!saChecked)	    
		uitestOperation.changeCountryToAUWhenCheckOut();
