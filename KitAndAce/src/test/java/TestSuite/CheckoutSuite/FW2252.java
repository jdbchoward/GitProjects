 ...
 * @Description: Tax estimation without saving address
 * @author: Howard
 * @compay: Kit and Ace
 * @date 1/23/2016
 * @version V1.0
...
public class FW2252 {
	...
	static Logger log = Logger.getLogger(FW2252.class.getName());
	...
	@Test
	public void testTaxEstimation() throws Exception {
