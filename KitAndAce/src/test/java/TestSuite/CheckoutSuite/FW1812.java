...
* @Description:  Zip code validation US anonimous user - positive 
* @author: Howard
* @compay: Kit and Ace     
* @date 1/18/2017 
* @version V1.0   
...
public class FW1812 {
	...
	static Logger log = Logger.getLogger(FW1812.class.getName());
	...
	public void zipValidationUSanonymousCheckOut() throws Exception {
		...
		//change country
		//California
		changeCountryVerifyZip(userHybris.getZip(),8,false);
		//New York
		changeCountryVerifyZip("10019",36,true);
	}
