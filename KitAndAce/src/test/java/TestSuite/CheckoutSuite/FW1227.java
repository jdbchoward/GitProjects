 ...
 * @Description: Logged user with SA, CC data. Page display. Positive
 * @author: Howard
 * @compay: Kit and Ace
 * @date 1/17/2016
 * @version V1.0
...
public class FW1227 {
	...
	static Logger log = Logger.getLogger(FW1227.class.getName());
	...
	public void testVerifyPrimaryShippingAddressOnCheckOutPage() throws Exception {
		...
		// add defult address and billing info
		...
		common.javascriptClick(driver, btnCheckOut);
		 ...
		 uitestOperation.checkBasicCheckOutInfo(true);	
