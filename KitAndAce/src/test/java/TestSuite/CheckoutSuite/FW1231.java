 ...
 * @Description: Add new CC for the Order. 'Same as SA' checkbox. Positive
 * @author: Howard
 * @compay: Kit and Ace
 * @date 1/19/2016
 * @version V1.0
...
public class FW1231 {
	...
	static Logger log = Logger.getLogger(FW1231.class.getName());
	...
	public void testConfirmationPageDisplay() throws Exception {
		...
		// verify
		uitestOperation.verifyAccountPage();
		common.javascriptClick(driver,
				driver.findElement(By.xpath("//li[@id='miniCartSlot']/button[@data-mini-cart-name='Cart']")));
		// click checkout button
		btnCheckOut = driver.findElement(By.xpath("//button[contains(text(),'Edit your options')]"));
		common.javascriptClick(driver, btnCheckOut);
		// place order
